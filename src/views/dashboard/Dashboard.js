    ...
    <>
      ...
      <CCard>
        <CCardBody>
          <CRow>
            <CCol sm="5">
              <h4 id="traffic" className="card-title mb-0">Hospital Attendance</h4>
        ...
        <CCardFooter>
          <CRow className="text-center">
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">In-patient</div>
              <strong>297 Members (40%)</strong>
              <CProgress
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0 d-md-down-none">
              <div className="text-muted">Out-patients</div>
              <strong>249 Members (20%)</strong>
              <CProgress
                className="progress-xs mt-2"
                precision={1}
                color="info"
                  ...
                  <CRow>
                    ...
                    <CCol sm="6">
                      <CCallout color="danger">
                        <small className="text-muted">Recurring Members</small>
                        <br />
                        <strong className="h4">229</strong>
                      </CCallout>
                    </CCol>
                  </CRow>
                ...
                <CCol xs="12" md="6" xl="6">
                  ...
                  <div className="progress-group">
                    <div className="progress-group-header">
                      ...
                      <span className="title">Coptic Hospital</span>
                      <span className="ml-auto font-weight-bold">513 <span className="text-muted small">(15%)</span></span>
                    </div>
                    <div className="progress-group-bars">
                  ...
                  <div className="progress-group">
                    <div className="progress-group-header">
                      ...
                      <span className="title">Kijabe Hospital</span>
                  ...
                  <div className="progress-group">
                    <div className="progress-group-header">
                      ...
                      <span className="title">Melchizedek</span>
                      <span className="ml-auto font-weight-bold">277<span className="text-muted small">(8%)</span></span>
                    </div>
                    <div className="progress-group-bars">
              ...
              <table className="table table-hover table-outline mb-0 d-none d-sm-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="text-center">
                    <span className="title">87000</span>
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={'	https://ackstaff-photos.s3.us-east-2.amazonaws.com/blank-profile-picture.png'} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                        <span className="c-avatar-status bg-success"></span>
                      </div>
                    </td>
                    <td>
                      <div>BRIAN THAIRU</div>
                      <div className="small text-muted">
                        {/* <span>New</span> | Registered: Jan 1, 2015 */}
                      </div>
                    </td>
                    ...
                    <td className="text-center">
                    <span className="title">89000</span>
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                    <span className="title">89896</span>
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                    <span className="title">67889</span>
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                    <span className="title">86789</span>
